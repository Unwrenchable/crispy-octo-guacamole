  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-pink-800 to-orange-700 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 right-20 w-72 h-72 bg-pink-300 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse-slow"></div>
        <div className="absolute bottom-20 left-20 w-72 h-72 bg-yellow-300 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse-slow" style={{animationDelay: '1s'}}></div>
      </div>
          ...
          <div className="space-y-5 animate-slide-up" style={{animationDelay: '0.1s'}}>
            <div>
              ...
              <input
                ...
                maxLength={4}
                className="w-full px-4 py-4 text-3xl text-center rounded-xl border-2 border-yellow-400 bg-white/20 text-white placeholder-white/40 focus:border-yellow-300 focus:ring-2 focus:ring-yellow-200/40 focus:outline-none tracking-widest font-bold transition-all duration-200"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-xl border-2 border-yellow-400 bg-white/20 text-white placeholder-white/40 focus:border-yellow-300 focus:ring-2 focus:ring-yellow-200/40 focus:outline-none transition-all duration-200"
              />
            </div>
            ...
            <button
              onClick={() => navigate('/')}
              className="w-full border-2 border-white/30 bg-white/10 text-white font-semibold py-3 px-6 rounded-xl transition-all duration-300 hover:border-yellow-400 hover:text-yellow-300 focus:outline-none"
            >
              ← Back to Home
            </button>
          </div>

          <div className="mt-6 text-center text-sm text-white/60 animate-fade-in" style={{animationDelay: '0.3s'}}>
